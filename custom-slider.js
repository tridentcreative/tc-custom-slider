var current_slide_1, current_slide_2, end_slide_1, end_slide_2, change_slide_status_1, change_slide_status_2, get_image_1, get_image_2, set_delay_1, set_delay_2, get_video_id_1, get_video_id_2, set_fade_1, set_fade_2, full_video_link_1, full_video_link_2, active_element_1, active_element_2, get_header_1, get_header_2, get_sub_header_1, get_sub_header_2, get_summary_1, get_summary_2;
...
get_content_1();
slider_action_1();
if ($.isNumeric(set_delay_1) == false) {
  change_slide_status_1 = false;
}
if ($.isNumeric(set_fade_1) == false) {
  set_fade_1 = 350;
}
...
get_content_2();
slider_action_2();
if ($.isNumeric(set_delay_2) == false) {
  change_slide_status_2 = false;
}
if ($.isNumeric(set_fade_2) == false) {
  set_fade_2 = 350;
}
